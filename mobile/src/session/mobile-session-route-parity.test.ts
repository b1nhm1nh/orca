...
// 530 -> 534, and every JSX hash: the header title became the workspace switcher's button (its
// Pressable, chevron and swipe handlers) and the surface mounts the switcher sheet.
const HEAD_RUNTIME_STRING_SHA256 =
  '4ef7c4a00b59f11a3cc504b5f97c35eb6981c42f20d9c043b75412f12424c710'
